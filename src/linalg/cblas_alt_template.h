...
template <> inline void cblas_gemv<double>( CBLAS_ORDER order,
   ...
   arma::dgemv_(cblas_transpose(TransA),&M,&N,&alpha,A,&lda,X,&incX,&beta,Y,&incY);
};
...
template <> inline void cblas_gemv<float>( CBLAS_ORDER order,
   ...
   arma::sgemv_(cblas_transpose(TransA),&M,&N,&alpha,A,&lda,X,&incX,&beta,Y,&incY);
};
///  Implementation of the INTTerface for cblas_sgemv
...
template <> inline void cblas_gemm<double>( CBLAS_ORDER order,
   ...
   arma::dgemm_(cblas_transpose(TransA),cblas_transpose(TransB),&M,&N,&K,&alpha,A,&lda,B,&ldb,&beta,C,&ldc);
};
...
template <> inline void cblas_gemm<float>( CBLAS_ORDER order,
   ...
   arma::sgemm_(cblas_transpose(TransA),cblas_transpose(TransB),&M,&N,&K,&alpha,A,&lda,B,&ldb,&beta,C,&ldc);
};
...
template <> inline void cblas_syrk<double>( CBLAS_ORDER order,
   ...
   arma::dsyrk_(cblas_uplo(Uplo),cblas_transpose(Trans),&N,&K,&alpha,A,&lda,&beta,C,&ldc);
};
...
template <> inline void cblas_syrk<float>( CBLAS_ORDER order,
   ...
   arma::ssyrk_(cblas_uplo(Uplo),cblas_transpose(Trans),&N,&K,&alpha,A,&lda,&beta,C,&ldc);
};
///  Implementation of the INTTerface for cblas_ssyrk
